...
const PlayerSuggestion: React.FC<{
  addPlayer: Function
  disabled: boolean
}> = ({ addPlayer, disabled }) => {
  ...
  const getSuggestionValue = (suggestion: Player) => suggestion.lastName

  const renderSuggestion = (suggestion: Player) => suggestion.lastName
